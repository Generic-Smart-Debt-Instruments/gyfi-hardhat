...
/// @author devneser
contract GYFIPool is IGYFIPool, ERC20SnapshotUpgradeable {
    ...
    function mint(uint256 _amountCurrency) public override {
        ...
        uint256 _amountDeposit =
            _amountCurrency.mul(totalSupply()).div(strategy.totalValue());
    ...
    function burn(uint256 _amountShares) public override {
        ...
        uint256 _amountWithdraw =
            _amountShares.mul(strategy.totalValue()).div(totalSupply());
